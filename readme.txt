...
Tested up to: 6.3
License: MIT
License URI: https://github.com/MattOndo/bald-theme/license.txt
...
Refer to the [GitHub repository](https://github.com/MattOndo/bald-theme/releases) for more information on version history and updates.
